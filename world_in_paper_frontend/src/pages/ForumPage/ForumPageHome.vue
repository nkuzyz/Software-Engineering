  ...
  <div class="common-layout">
    <el-container class="homepage">
      <el-aside>
        ...
        <el-row>
          <el-col :span="40" style="height: 10px" />
        </el-row>
        <AuthorsList />
      </el-aside>
      <el-main>
        ...
        <ArticleList  @transfer-topic-total="getTopicTotal"/>
        
        <div class="go-top">
            <el-button type="danger" plain round size="large"
                 @click="createTopic">发布<br />帖子</el-button>
         
        </div>
      </el-main>
    </el-container>
    <add-topic ref="addTopic"></add-topic>
  </div>
</template>
