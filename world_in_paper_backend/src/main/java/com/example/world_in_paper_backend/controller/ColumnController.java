...
public class ColumnController {
    ...
    public R<List<Map<String,Object>>> getColumnArticles(@RequestParam Integer currentPage,@RequestParam Integer pageSize,@RequestParam String columnId){
        return columnServiceImp.getColumnArticles(currentPage,pageSize,Integer.parseInt(columnId));
    }
